...
import com.example.lc_management_software.AppendableObjectOutputStream;
...
// Proceed with file operations
        ...
        try {
            ...
            User u = new User(email, name, confirmPass, address, phone, dob, date, role, "Pending");
            oos.writeObject(u);
...
//      save the access log to the access logs btn
        try {
            ...
            AccessLog al = new AccessLog(email, "Requesting for " + role, LocalDate.now());
            oos.writeObject(al);
